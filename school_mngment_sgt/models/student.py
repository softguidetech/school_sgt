...
class StudentStudent(models.Model):
    ...
    def create(self, vals):
        ...
        if res.state == "draft":
            admission_group = self.env.ref("school_mngment_sgt.group_is_admission")
            new_grp_list = [admission_group.id, emp_grp.id]
            res.user_id.write({"groups_id": [(6, 0, new_grp_list)]})
        elif res.state == "done":
            done_student = self.env.ref("school_mngment_sgt.group_school_student")
    ...
    def admission_done(self):
        ...
        student_group = self.env.ref("school_mngment_sgt.group_school_student")
